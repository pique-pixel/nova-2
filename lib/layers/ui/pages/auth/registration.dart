    ...
    return Container(
      ...
      child: FlatButton(
        ...
        child: Row(
          ...
          children: <Widget>[
           !widget.isLoading ? SizedBox.shrink() : CircularProgressIndicator(valueColor: AlwaysStoppedAnimation(Colors.white)),
            !widget.isLoading ? SizedBox.shrink() : SizedBox(width: 20,),
            Text(widget.isLoading ? 'Please wait' :
              widget.text,
              style: TextStyle(
