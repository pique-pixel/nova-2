...
class PlanMapPage extends StatefulWidget {
  ...
  const PlanMapPage({Key key, this.listCardData}) : super(key: key);
...
class _PlanMapPageState extends State<PlanMapPage> {
  ...
  double zoomButtonsTopCalculatingFunction({
    ...
    return  (screenHeight + topPadding - (x * (_panelHeightOpen -
        _panelHeightClosed))) / 2 - _panelHeightClosed;
  }
...
//              print(pos);
  ...
  Widget itemsPlan(ScrollController sc) {
    return
    Column(
    children:[
      Container(
...
//      color: Colors.redAccent,
                        ...
                        children: [
                          ...
                          _ModalButton(
                            ...
                            onTap: () {
                              print("delete");
                              Navigator.of(context).pop();
                              showDeleteDialog(context,"Удалить активность","Если удалить эту активность, она будет исключена "
  ...
  Future showDeleteDialog(context,title,text){
    return showDialog(
        context: context,
        builder: (BuildContext context) {
          return Dialog(
...
//                          mainAxisAlignment: MainAxisAlignment.spaceBetween,
                          children: <Widget>[
                            ...
                            _ModalButton(
                              ...
                              background: AppColors.backgroundGray,
                              color: AppColors.darkGray,
                              radius: BorderRadius.only(bottomLeft: Radius
                                  .circular(16)),
                              onTap: () {
                                Navigator.of(context).pop();
                              },
...
//                            ),
                            ...
                            _ModalButton(
                              ...
                              radius: BorderRadius.only(bottomRight: Radius
                                  .circular(16)),
                              onTap: () {
                                Navigator.of(context).pop();
                              },
...
class _ModalButton extends StatelessWidget {
  ...
  const _ModalButton({Key key, this.text, this.background,
    this.color,
    this.radius,
    this.onTap}) :
    super(key: key);
      ...
      Padding(
        ...
        Align(
          ...
          SizedBox(
            ...
            IconButton(
              padding: EdgeInsets.all(0),
              icon: Icon(Icons.add_circle, color: AppColors.primaryRed),
              onPressed: () {
...
class _GrayMark extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      height: 4,
      width: 32,
      decoration: BoxDecoration(color: Colors.black12, borderRadius: BorderRadius.all(Radius.circular(4))),
    );
  }
}
